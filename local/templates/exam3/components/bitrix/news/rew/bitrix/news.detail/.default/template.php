...
<div class="review-block">
	...
	<div style="clear: both;" class="review-img-wrap"><img src="<?if(isset($arResult["DETAIL_PICTURE"]["SRC"])):?><?=$arResult["DETAIL_PICTURE"]["SRC"]?><?else:?>/local/templates/exam3/img/no_photo.jpg<?endif;?>" alt="img"></div>
</div>
