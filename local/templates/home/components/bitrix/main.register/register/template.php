...
<?foreach ($arResult["SHOW_FIELDS"] as $FIELD):?>
	...
	<?else:?>
		<tr>
			<td>
			<label class="font-weight-bold" for="fullname"><?=GetMessage("REGISTER_FIELD_".$FIELD)?>:<?if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"):?><?endif?></label>
			</td>
			<td><?
	switch ($FIELD)
	{
...
<?if($arResult["USER_PROPERTIES"]["SHOW"] == "Y"):?>
	...
	<tr><td>
	<label class="font-weight-bold" for="fullname"><?=$arUserField["EDIT_FORM_LABEL"]?>:<?if ($arUserField["MANDATORY"]=="Y"):?><?endif;?></label>	</td><td>
			<?$APPLICATION->IncludeComponent(
...
if ($arResult["USE_CAPTCHA"] == "Y")
{
	?>
		...
		<tr>
			<td><label class="font-weight-bold" for="fullname"><?=GetMessage("REGISTER_CAPTCHA_PROMT")?>:</label></td>
...
?>
	...
	<tfoot>
		<tr>
			<td></td>
			<td><input class="btn btn-primary  py-2 px-4 rounded-0" type="submit" name="register_submit_button" value="<?=GetMessage("AUTH_REGISTER")?>" /></td>
		</tr>
	</tfoot>
</table>
</form>
