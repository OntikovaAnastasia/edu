...
<div class="review-block">
	<div class="review-text">
		...
		<div class="review-autor">
			<?echo $arResult["NAME"];?>, <?echo $arResult["DISPLAY_ACTIVE_FROM"]?>, <?=$arResult["DISPLAY_PROPERTIES"]["POSITION"]["VALUE"]?>, <?=$arResult["DISPLAY_PROPERTIES"]["COMPANY"]["VALUE"]?>.
		</div>
	</div>
	<div style="clear: both;" class="review-img-wrap"><img src="<?if(isset($arResult["DETAIL_PICTURE"]["SRC"])):?><?=$arResult["DETAIL_PICTURE"]["SRC"]?><?else:?>/local/templates/exam5/img/no_photo.jpg<?endif;?>" alt="img"></div>
</div>
