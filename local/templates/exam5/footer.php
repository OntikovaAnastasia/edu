...
?>
				...
				<?$APPLICATION->IncludeComponent(
                    ...
                    <div class="side-wrap">
                        ...
                        <?$APPLICATION->IncludeComponent("bitrix:catalog.section", "rew_left", Array(
                            "ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
                                ...
                                "PAGE_ELEMENT_COUNT" => "2",	// Количество элементов на странице
                    ...
                    <div class="phone"><a href="tel:84952128506">
                        <?$APPLICATION->IncludeComponent(
                            ...
                            Array(
                                ...
                                "AREA_FILE_SUFFIX" => "inc",
                                "EDIT_TEMPLATE" => "",
                                "PATH" => "/local/include/footer_phone.php"
                            )
                        );?></a>
                    </div>
                </div>
